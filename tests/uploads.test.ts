import fs from 'fs';
import type { ResponseLike } from '@departmentofgovernmentefficiency/sdk/internal/to-file';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('@departmentofgovernmentefficiency/sdk/core/uploads');
    await expect(
